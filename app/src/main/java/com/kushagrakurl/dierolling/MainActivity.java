...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, AddNewDie.UpdateDieArray {
    ...
    protected void onDestroy() {
        ...
        //editor.putStringSet("logHistory", setFull);
        editor.apply();
    }
